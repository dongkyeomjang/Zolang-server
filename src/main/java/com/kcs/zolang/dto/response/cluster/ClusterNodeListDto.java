...
public record ClusterNodeListDto(
        ...
        @Schema(description = "node moemory 할당", example = "3446636Ki")
        ...
        String capacityCpu,
        @Schema(description = "node moemory capacity", example = "4001644Ki")
    ...
    public static ClusterNodeListDto fromEntity(V1Node node) {
