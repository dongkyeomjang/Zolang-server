package com.kcs.zolang.security.handler.logout;
...
public class CustomLogoutProcessHandler implements LogoutHandler {
    ...
    public void logout(
        ...
        userRepository.updateRefreshTokenAndLoginStatusAndGithubAccessToken(userPrincipal.getUserId(), null, false, null);
    }
}
